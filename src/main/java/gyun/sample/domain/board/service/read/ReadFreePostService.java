...
@Slf4j
public class ReadFreePostService extends AbstractReadPostService {

    public ReadFreePostService(PostRepository postRepository, PostLikeRepository postLikeRepository) {
