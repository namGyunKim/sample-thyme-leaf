...
public class SocialController {
    ...
    // private final ApplicationEventPublisher eventPublisher; // 중복 로그 방지를 위해 제거
    ...
    public String googleRedirect(@RequestParam String code, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            // 서비스 내부에서 가입/로그인 처리 및 해당 로그 이벤트(JOIN/LOGIN) 발행이 완료됨
            ...
            // [수정] 여기서 별도의 로그 이벤트를 발행하지 않음 (GoogleSocialService와 중복 방지)
